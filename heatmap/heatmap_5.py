...
per_segments = list(range(9))
rprs_segments = [x / 22.5 for x in range(9)]
...
#uncomment if extra
        ...
        period = np.random.uniform(low=0.1, high=26)
#period = 8.0
...
blockpercent_txt=open("/Users/sheilasagear/Desktop/blockpercentD_txt.txt",'w')
...
plt.savefig('/Users/sheilasagear/Desktop/EPIC229227260-3E-heatmap.png')
