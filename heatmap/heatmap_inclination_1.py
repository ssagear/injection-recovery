...
per_segments = np.logspace(-.5228787, 1.415, num=8, endpoint=True, base=10)
...
np.savetxt(targetname + 'inclination.csv', block_percent, fmt='%f', delimiter=',')
