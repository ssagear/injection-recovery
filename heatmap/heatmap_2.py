...
r_list = [[0 for i in range(5)] for j in range(4)]

u_list = [[0 for i in range(5)] for j in range(4)]
...
###################################################################################
        ...
        if abs(bestFperiod-period) < .03*period and abs(bestFrprs-rprs) < .03*rprs:
            ...
            if period > 0 and period < 5:
                if rprs > 0 and rprs < .1:
                    r_list[0][0] += 1
                if rprs > .1 and rprs < .2:
                    r_list[1][0] += 1
                if rprs > .2 and rprs < .3:
                    r_list[2][0] += 1
                if rprs > .3 and rprs < .4:
                    r_list[3][0] += 1
            if period > 5 and period < 10:
                if rprs > 0 and rprs < .1:
                    r_list[0][1] += 1
                if rprs > .1 and rprs < .2:
                    r_list[1][1] += 1
            ...
            """
            if period > 0 and period < 5:
                rp0to5.append(period)
            if period > 5 and period < 10:
                rp5to10.append(period)
            if period > 10 and period < 15:
                rp10to15.append(period)
            if period > 15 and period < 20:
                rp15to20.append(period)
            if period > 20 and period < 25:
                rp20to25.append(period)
            if rprs > 0 and rprs < .1:
                rr0to1.append(rprs)
            if rprs > .1 and rprs < .2:
                rr1to2.append(rprs)
            ...
            """
            if period > 0 and period < 5:
                up0to5.append(period)
            if period > 5 and period < 10:
                up5to10.append(period)
            if period > 10 and period < 15:
                up10to15.append(period)
            if period > 15 and period < 20:
                up15to20.append(period)
            if period > 20 and period < 25:
                up20to25.append(period)
            if rprs > 0 and rprs < .1:
                ur0to1.append(rprs)
            if rprs > .1 and rprs < .2:
                ur1to2.append(rprs)
...
print(r_list, u_list)
"""
print(rp0to5, rp5to10, rp10to15, rp15to20, rp20to25)
print(rr0to1, rr1to2, rr2to3, rr3to4)

print(up0to5, up5to10, up10to15, up15to20, up20to25)
print(ur0to1, ur1to2, ur2to3, ur3to4)
"""

block_percent = [[0 for i in range(5)] for j in range(4)]

for i in range(4):
    for j in range(5):
        if u_list[i][j]+r_list[i][j] > 0:
            block_percent[i][j] = r_list[i][j]/(u_list[i][j]+r_list[i][j])
