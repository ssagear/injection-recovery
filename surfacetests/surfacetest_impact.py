...
import bls, ktransit, pylab, os, untrendy, math
...
def main():
    ...
    plt.figure()
    plt.plot(time, tmod)
    plt.title(str(name) + ' impact = ' + str(impact))
    #plt.show()
    plt.savefig('/Users/sheilasagear/Dropbox/K2/surfacetest/images_impact/impact' + str(impact) + '.png')
...
for i in range(1000):#however many planets you want to try
    main()
