...
file = 'hlsp_k2sff_k2_lightcurve_229227246-c06_kepler_v1_llc-default-aper.csv'

with open(r'/Users/sheilasagear/Dropbox/K2/K2_targets/Cycle2_4_CSV/hlsp_k2sff_k2_lightcurve_229227246-c06_kepler_v1_llc-default-aper.csv') as f:
    reader = csv.reader(f)
