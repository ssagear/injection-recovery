...
ax.set_ylabel('$R_P$/$R_s$', fontsize=20)
ax.tick_params(labelsize=20)
ax.set_ylim(0, 0.4)
ax.set_xlim(0, 26)

ax.set_xlabel('Orbital Period (days)', fontsize=20)
ax.set_title('EPIC 229227260', fontsize=20)
ax.hold(True)


data = open('/Users/sheilasagear/github/ldwarfs/recovery_data_229227260a.csv', 'a')
...
###################################################################################
        ...
        if abs(bestFperiod-period) < .03*period and abs(bestFrprs-rprs) < .03*rprs:
            ...
            ax.scatter(period, rprs, c='b', s=8)
            with open(r'/Users/sheilasagear/github/ldwarfs/recovery_data_229227260a.csv', 'a') as data:
                writer = csv.writer(data)
                writer.writerows([[period, rprs]])

        else:
            #ax.scatter(period, rprs, c='r', s=8)
            pass
...
plt.savefig('/Users/sheilasagear/Desktop/EPIC229227260-3.png')
