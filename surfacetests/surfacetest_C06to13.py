...
ax.set_ylabel('Injected SNR', fontsize=14)

ax.set_title('Campaign 6 to 13 stars')
ax.hold(True)
...
##########################
            ...
            dur = PyAstronomy.pyasl.transitDuration(.0337, .17, .1, 90, 8)
