...
def createT(time, T0):#time array, transit mid-time
    ...
    ld3=0.0, # if all four parameters are non-zero we use non-linear limb darkening
    ld4=0.0, 
...
def main():
    ...
    path = '/Users/sheilasagear/Dropbox/K2/K2_targets/C06to13fits/hlsp_k2sff_k2_lightcurve_229227269-c06_kepler_v1_llc.fits'
